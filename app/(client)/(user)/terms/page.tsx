    ...
    <Container className="max-w-3xl sm:px-6 lg:px-8 py-12">
      ...
      <div>
        ...
        <section>
          ...
          <p>
            You agree to use TronCommerce&apos;s services only for lawful purposes and in
        ...
        <section>
          <h2 className="text-xl font-semibold my-2">4. Limitations of Liability</h2>
          <p>
            In no event shall TronCommerce or its suppliers be liable for any damages
            (including, without limitation, damages for loss of data or profit,
            or due to business interruption) arising out of the use or inability
            to use the materials on TronCommerce website, even if TronCommerce or a Tulos
            authorized representative has been notified orally or in writing of
            the possibility of such damage.
          </p>
        </section>
        <section>
          <h2 className="text-xl font-semibold my-2">5. Revisions and Errata</h2>
          <p>
            The materials appearing on TronCommerce website could include technical,
            typographical, or photographic errors. TronCommerce does not warrant that any
            of the materials on its website are accurate, complete, or current.
            TronCommerce may make changes to the materials contained on its website at any
            time without notice. TronCommerce does not, however, make any commitment to
        ...
        <section>
          <h2 className="text-xl font-semibold my-2">7. Site Terms of Use Modifications</h2>
          <p>
            TronCommerce may revise these terms of use for its website at any time without
